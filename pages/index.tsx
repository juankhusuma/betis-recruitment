        ...
        <main>
          ...
          {openForm && (
            ...
            >
              ...
              <img
                className="z-50 md:w-1/2 blur-[2px] h-[150px] md:h-[450px] object-cover object-center rounded-tr-xl rounded-br-xl"
                src="/bread.jpg"
                alt="bread"
              ></img>
              <fieldset className="flex flex-col p-4 md:p-8 text-sm">
                ...
                <input
                  className="px-2 py-1 max-w-[250px] mb-4 border border-green-500 rounded-md cursor-pointer"
                  type="file"
                  name="image"
                  required
                />
          ...
          <div className="grid md:grid-cols-[1fr,1fr] lg:grid-cols-[1fr,1fr,1fr] place-items-center gap-y-8 mx-5 my-10">
            {data.map(({ id, name, description, expired_date, image }, idx) => (
              <Card
                key={id}
                name={name}
